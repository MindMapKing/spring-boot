...
File main = new File(basedir, "target/jar-classifier-source-attach-disabled-0.0.1-test.jar")
File backup = new File(basedir, "target/jar-classifier-source-attach-disabled-0.0.1-test.jar.original")
